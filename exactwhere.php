...
<html>
  ...
  <body>
    <nav class="navbar navbar-default">
      <div class="container-fluid">
        <div class="navbar-header">
          <a class="navbar-brand" href="index.php">My Maps</a>
        </div>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBq03ai0h9ZJIG98uuqhwbCk8eTkwRW1EE&libraries=places&callback=initAutocomplete"
         async defer></script>
  </body>
</html>
